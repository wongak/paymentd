...
-- Fri 19 Dec 2014 02:41:27 PM CET
...
-- -----------------------------------------------------
-- Table `fritzpay_principal`.`project_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fritzpay_principal`.`project_status` ;

CREATE TABLE IF NOT EXISTS `fritzpay_principal`.`project_status` (
  `project_id` INT UNSIGNED NOT NULL,
  `timestamp` BIGINT UNSIGNED NOT NULL,
  `created_by` VARCHAR(64) NOT NULL,
  `status` VARCHAR(32) NOT NULL,
